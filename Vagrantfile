Vagrant.configure("2") do |config|
  ...
  config.vm.define "app-pxc", primary: true do |app_config|
     ...
     app_config.vm.network "private_network", ip: "192.168.90.200"
     app_config.vm.network "forwarded_port", guest: 80, host: 8085
  ...
  (1..3).each do |i|
    config.vm.define "pxc#{i}" do |node|
      ...
      node.vm.network "private_network", ip: "192.168.90.#{i}0"
